...
class PragueActivity : CityActivity() {

    override val cityPrefsName: String = "prague_prefs"
    ...
    private val PREFS_NAME = "prague_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_prague"
    private val NOTES_KEY = "notes_prague"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Prague")
