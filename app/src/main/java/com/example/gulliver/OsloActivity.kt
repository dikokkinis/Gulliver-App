...
class OsloActivity : CityActivity() {

    override val cityPrefsName: String = "oslo_prefs"
    ...
    private val PREFS_NAME = "oslo_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_oslo"
    private val NOTES_KEY = "notes_oslo"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_oslo)
