...
class AmsterdamActivity : CityActivity() {

    override val cityPrefsName: String = "amsterdam_prefs"
    ...
    private val PREFS_NAME = "amsterdam_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_amsterdam"
    private val NOTES_KEY = "notes_amsterdam"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_amsterdam)
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Amsterdam") // Change accordingly
