...
class NaplesActivity : CityActivity() {

    override val cityPrefsName: String = "naples_prefs"
    ...
    private val PREFS_NAME = "naples_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_naples"
    private val NOTES_KEY = "notes_naples"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_naples)
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Naples")
