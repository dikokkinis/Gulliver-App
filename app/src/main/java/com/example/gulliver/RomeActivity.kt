...
class RomeActivity : CityActivity() {

    override val cityPrefsName: String = "rome_prefs"
    ...
    private val PREFS_NAME = "rome_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_rome"
    private val NOTES_KEY = "notes_rome"
