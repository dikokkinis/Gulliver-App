...
class BerlinActivity : CityActivity() {


    override val cityPrefsName: String = "berlin_prefs"
    ...
    private val PREFS_NAME = "berlin_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_berlin"
    private val NOTES_KEY = "notes_berlin"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Berlin")
