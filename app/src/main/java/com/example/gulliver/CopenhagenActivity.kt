...
class CopenhagenActivity : CityActivity() {


    override val cityPrefsName: String = "copenhagen_prefs"
    ...
    private val PREFS_NAME = "copenhagen_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_copenhagen"
    private val NOTES_KEY = "notes_copenhagen"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Copenhagen")
