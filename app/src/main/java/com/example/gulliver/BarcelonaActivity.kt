...
class BarcelonaActivity : CityActivity() {


    override val cityPrefsName: String = "barcelona_prefs"
    ...
    private val scheduleCards = listOf(
        ...
        Pair("day5", R.id.day5Card),
        Pair("day6", R.id.day6Card)
    )

    private lateinit var budgetEditText: EditText

    private val PREFS_NAME = "barcelona_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_barcelona"
    private val NOTES_KEY = "notes_barcelona"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Barcelona")
