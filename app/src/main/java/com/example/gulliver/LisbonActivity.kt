...
class LisbonActivity : CityActivity() {


    override val cityPrefsName: String = "lisbon_prefs"
    ...
    private val PREFS_NAME = "lisbon_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_lisbon"
    private val NOTES_KEY = "notes_lisbon"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Lisbon")
