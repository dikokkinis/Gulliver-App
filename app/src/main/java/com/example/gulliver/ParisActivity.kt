...
class ParisActivity : CityActivity() {

    override val cityPrefsName: String = "paris_prefs"
    ...
    private val PREFS_NAME = "paris_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_paris"
    private val NOTES_KEY = "notes_paris"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Paris")
