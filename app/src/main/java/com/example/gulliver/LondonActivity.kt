...
class LondonActivity : CityActivity() {


    override val cityPrefsName: String = "london_prefs"
    ...
    private val PREFS_NAME = "london_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_london"
    private val NOTES_KEY = "notes_london"
