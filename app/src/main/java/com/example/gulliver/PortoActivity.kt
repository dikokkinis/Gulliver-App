...
class PortoActivity : CityActivity() {

    override val cityPrefsName: String = "porto_prefs"
    ...
    private val PREFS_NAME = "porto_prefs"
    private val BUDGET_KEY = "budget_value"
    private val HISTORY_KEY = "history_porto"
    private val NOTES_KEY = "notes_porto"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cityTicketButton.setOnClickListener {
            ...
            intent.putExtra("cityName", "Porto")
